...
public class PbaDesignPcbRelatedAttachment extends EntityDate {
     ...
     * @param originName
     */
    public PbaDesignPcbRelatedAttachment(
            String originName,
            String tag,
     ...
     * @param originName
     */
    public PbaDesignPcbRelatedAttachment(String originName) {
