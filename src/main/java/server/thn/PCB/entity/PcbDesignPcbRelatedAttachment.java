...
public class PcbDesignPcbRelatedAttachment extends EntityDate {
     ...
     * @param originName
     */
    public PcbDesignPcbRelatedAttachment(
            String originName,
            String tag,
     ...
     * @param originName
     */
    public PcbDesignPcbRelatedAttachment(String originName) {
