...
public class SchematicDesignPcbRelatedAttachment extends EntityDate {
    ...
    private final static String supportedExtension[] =
            {"brd", "pdf", "txt", "dsn", "par", "drd", "BRD", "PDF", "TXT", "DSN", "PAR", "DRD"};
     ...
     * @param originName
     */
    public SchematicDesignPcbRelatedAttachment(
            String originName,
            String tag,
     ...
     * @param originName
     */
    public SchematicDesignPcbRelatedAttachment(String originName) {
    ...
    private String extractExtension(String originName) {
        try {
            ...
            if (isSupportedFormat(ext)) {return ext;}
                ...
                throw new UnSupportedExtractionException();
            }
